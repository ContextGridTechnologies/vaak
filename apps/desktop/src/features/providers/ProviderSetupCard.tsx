  ...
  if (mode === "select") {
    return (
      <Button
        ...
        className={cn(
          "h-auto min-h-8 w-full justify-center gap-2 rounded-lg px-2.5 py-1.5 text-center shadow-none hover:shadow-none",
          selected &&
            "border-primary/20 bg-primary/12 text-foreground hover:border-primary/25 hover:bg-primary/15 hover:text-foreground",
        )}
        onClick={onSelect}
      >
